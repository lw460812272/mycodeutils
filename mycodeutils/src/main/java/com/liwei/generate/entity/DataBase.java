package com.liwei.generate.entity;
...
public class DataBase {
                                     //             127.0.0.1：3306/ihrm
    private static String mysqlUrl = "jdbc:mysql://[ip]:[port]/[db]?useUnicode=true&characterEncoding=UTF-8";
    ...
    public DataBase(String dbType,String ip,String port,String db) {
        ...
        }else if("ORACLE".endsWith(dbType.toUpperCase())){
